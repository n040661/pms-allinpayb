...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        long startTimestampMs = WxUtils.getCurrentTimestampMs();
        ...
        try {
            ...
            elapsedTimeMillis = WxUtils.getCurrentTimestampMs()-startTimestampMs;
            ...
            firstHasDnsErr = true;
            elapsedTimeMillis = WxUtils.getCurrentTimestampMs()-startTimestampMs;
            WxUtils.getLogger().warn("UnknownHostException for domainInfo {}", domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = WxUtils.getCurrentTimestampMs()-startTimestampMs;
            WxUtils.getLogger().warn("connect timeout happened for domainInfo {}", domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
            ...
            elapsedTimeMillis = WxUtils.getCurrentTimestampMs()-startTimestampMs;
            WxUtils.getLogger().warn("timeout happened for domainInfo {}", domainInfo);
            WXPayReport.getInstance(config).report(
                    uuid,
                    elapsedTimeMillis,
                    domainInfo.domain,
