package com.dominator.app.utils;

/**
 * Created by zhangsuliang on 2018/5/2.
 */
...
public class AlipayUtil {
    ...
    public static boolean rsaCheck(Map<String, String> params) throws AlipayApiException {
        return AlipaySignature.rsaCheckV1(params, AlipayConfig2.ALIPAY_PUBLIC_KEY, AlipayConfig2.CHARSET, AlipayConfig2.SIGN_TYPE);
    }
    ...
    public static String rsaSign (Map<String, String> params) throws AlipayApiException{
        ...
        return AlipaySignature.rsaSign(content, AlipayConfig2.PRIVATE_KEY, AlipayConfig2.CHARSET, AlipayConfig2.SIGN_TYPE);
    }
    ...
    public static String rsaDecrypt(Map<String, String> params) throws AlipayApiException{
        return AlipaySignature.checkSignAndDecrypt(params, AlipayConfig2.ALIPAY_PUBLIC_KEY, AlipayConfig2.PRIVATE_KEY, true, true, AlipayConfig2.SIGN_TYPE);
    }
    /**
    ...
    public static String verifyResponse(String notifyId) {
        ...
        String urlValue = HTTPS_VERIFY_URL + "partner=" + AlipayConfig2.SELLER_ID + "&notify_id=" + notifyId;
    ...
    public static String getNotifyUrl(HttpServletRequest request){
        ...
        return requestURL.substring(0,requestURL.indexOf("/front/"))+ AlipayConfig2.NOTIFY_URL;
    }
    ...
    public static void logResult(String word) {
        ...
        try {
            writer = new FileWriter(AlipayConfig2.LOG_PATH + "alipay_log_" + System.currentTimeMillis()+".txt");
            writer.write(word);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
